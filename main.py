...
year1_L.grid(row=2, column=0, sticky="w")
year1_E = tk.Entry(root, width=7)
year1_E.grid(row=2, column=1, sticky="ew")
month1_L = tk.Label(root, text=" 月 :")
month1_L.grid(row=2, column=2, sticky="ew")
month1_E = tk.Entry(root, width=3)
month1_E.grid(row=2, column=3, sticky="ew")
day1_L = tk.Label(root, text=" 日 :")
day1_L.grid(row=2, column=4, sticky="ew")
day1_E = tk.Entry(root, width=3)
day1_E.grid(row=2, column=5, sticky="ew")
...
day2_L.grid(row=4, column=4, sticky="ew")
day2_E = tk.Entry(root, width=3)
day2_E.grid(row=4, column=5, sticky="ew")
